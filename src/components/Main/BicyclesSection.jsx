...
const BicyclesSection = () => {
    return (
        <>
            <section className="flex flex-col items-start px-6 sm:px-14 md:px-16 lg:px-40 justify-center bg-[url(images/Bysicle/Bysicle.png)] w-full h-48 md:h-[500px] xl:h-[600px] bg-cover bg-center">
                <h5 className="flex flex-col mb-8 text-sm sm:text-base md:text-xl xl:text-2xl font-vazirB">
                    <span className="font-light pb-1">برای لذت بردن از مسیر </span>
                    <span className=" md:font-medium">دوچرخه، اسکیت و  اسکوتر بگیر</span>
                </h5>
...
export default BicyclesSection