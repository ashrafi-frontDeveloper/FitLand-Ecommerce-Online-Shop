    ...
    return (
        <>
            <section className=" relative flex flex-col items-start px-6 sm:px-14 md:px-16 lg:px-40 justify-center bg-[url(images/camp/camp.png)] w-full h-48 md:h-[500px] xl:h-[600px] bg-cover bg-center">
                <h5 className=" absolute top-6 sm:top-5 md:top-14 lg:top-16 xl:top-20 right-8 sm:right-24 md:right-10 lg:right-20 xl:right-36 flex flex-col mb-8 text-sm sm:text-base md:text-xl xl:text-2xl text-white font-vazirB">
