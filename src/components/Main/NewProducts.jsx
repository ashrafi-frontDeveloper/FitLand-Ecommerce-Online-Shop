        ...
        <>
            <section className="container flex flex-row items-center justify-center md:justify-between 2xl:justify-around gap-y-6 gap-x-4 xl:gap-x-6 mx-auto md:px-2 lg:px-14 xl:px-24">
                ...
                {newProducts.map((product , index) => {
                    return (
                    // <div key={index} className=" relative group max-w-xs overflow-hidden w-44 md:w-[392px] h-64 md:h-[462px] bg-background rounded-2xl ">
                    //     <img src={product.img} alt="product" className="w-full object-cover rounded-t-xl transition-all duration-300 group-hover:brightness-50" />

                    // {/* Hover Overlay Content */}
                    // <div className="absolute inset-0 -top-20 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    //     <p className="text-white text-center text-sm xl:text-lg font-vazirB">
