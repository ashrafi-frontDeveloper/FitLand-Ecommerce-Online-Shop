...
const products = [
    {id: 1, img: 'images/discound-product/img1.png' , name: 'سویشرت نایک مدل AO-14' , price: 300_000 , size: 'از سایز L تا XXL'},
    {id: 2, img: 'images/discound-product/img2.jpg' , name: 'ست نایک مدل S-2000', price: 200_000, size: 'از سایز L تا XXL'},
    {id: 3, img: 'images/discound-product/img3.png', name: 'کفش نایک مدل S-2000', price: 200_000, size: 'از سایز L تا XXL'},
]
                ...
                <div className="flex items-center justify-between">
                    ...
                    products.map(product => (
                        ...
                        <div className=" relative w-[366px] h-[467px] mt-20 bg-white rounded-4xl">
                            {/* icon discound */}
                            <div className="absolute left-2 top-2.5 "><FcVip className="w-10 h-10" /></div>
                            {/* img */}
